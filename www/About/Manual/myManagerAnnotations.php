...
<li><strong>Feedback</strong>: please use this link to our automated feedback system. We appreciate your comments so that 
	...
	<a href="<?php echo $config->domain; ?>About/Manual/graphicGuide.php" target="_blank" >guide to Morphbank graphics</a> for a thorough
	overview.
		<ul>
	...
	<li>In Morphbank, the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" />
	 ...
	 <a href="<?php echo $config->domain; ?>About/Manual/annotationEdit.php">Edit Annotation</a> section.</li>
...
<strong>.XML </strong> and <strong>Taxon Name</strong> (see <a href="<?php echo $config->domain; ?>About/Manual/annotation.php">Types of Annotations</a>).</li>
	</li>
</ul>

<h3>More Annotation Topics</h3><br />
<p><a href="<?php echo $config->domain; ?>About/Manual/annotation.php" target="_blank"><strong>What is an Annotation?/ Types of Annotations</strong></a>
<br />
<a href="<?php echo $config->domain; ?>About/Manual/annotationAdd.php" target="_blank"><strong>How and Where to Add an Annotation</strong></a>
<br />
<a href="<?php echo $config->domain; ?>About/Manual/annotationEdit.php" target="_blank"><strong>Editing an Annotation</strong></a>
<br />
<a href="<?php echo $config->domain; ?>About/Manual/annotationShow.php" target="_blank"><strong>What does an Annotation Single Show look like?</strong></a>
<br />
<a href="<?php echo $config->domain; ?>About/Manual/annotate_taxon_name.php" target="_blank"><strong>How to Annotate a taxon name</strong></a>
</p>
...
<h3>Clicking the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" />
...
<img src="ManualImages/annotation_manager_add_annotation.jpg" vspace="5"/>
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/annotation.php" class="button smallButton"><div>Next</div></a></td>
