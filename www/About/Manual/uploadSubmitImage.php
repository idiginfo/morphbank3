...
<a href="<?php echo $config->domain; ?>About/Manual/Movies/submitimage.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Submit an Image</strong>: <a href="<?php echo $config->domain; ?>About/Manual/Movies/submitimage.avi" target='_blank'>video</a>
</div>
-->
<p>
...
<p>N.B. If a user belongs to more than one <a href="<?php echo $config->domain; ?>About/Manual/selectGroup.php">Morphbank Group</a> - be sure to <a href="<?php echo $config->domain; ?>About/Manual/selectGroup.php">select the group</a> for this Image before upload.
</p>
...
<strong>Add Specimen</strong> screen. (See the <a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitSpecimen.php">Add Specimen</a>
...
(See the <a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitView.php">Add View</a> section of this manual for help in completing this form.)
...
images or click return (goes to the front page of Morphbank) or click on the desired destination using drop-downs in the <strong>Header Menu</strong>.
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitPublication.php" class="button smallButton"><div>Next</div></a></td>
