...
<p>Morphbank uses FSI (Flash-based Single Source Image) Viewer by Neptune Labs
(<a href="http://www.fsi-viewer.com/" target="_blank">http://www.fsi-viewer.com/</a>) as a vehicle to display and manipulate the stored images.
As stated by Neptune Labs, <em>the FSI Viewer is a web-based viewer for high resolution
images. It enables internet users to magnify image sections or view objects from different
viewing angles or in different states, requiring low bandwidth only. This makes
presentations more appealing. FSI Viewer is based on Macromedia Flash<sup>&#8482;</sup>Plug-in
client-side and accesses image data provided by single source imaging servers. These
servers provide scaled and compressed image data on-demand based on high resolution
source images.</em>
</p>
In Morphbank the viewer is accessed several ways. 
<ul>
<li>The <img src="../../style/webImages/magnifyShadow-trans.png" alt="FSIviewer icon"> icon will open a given image in the FSI Viewer. This <img src="../../style/webImages/magnifyShadow-trans.png" alt="FSIviewer icon"> icon is present for any image in Morphbank in the My Manager <strong>Images</strong> or <strong>All</strong> tabs. Simply go to Header Menu > Browse > Images or Header Menu > Browse > All to get to these tabs.</li>
<li>The user may click on the <img src="../../style/webImages/infoIcon-trans.png" alt="i icon"/> icon or thumbnail to open the Single Show for any given image in Morphbank. Then, click on the image there or the link just below the image that reads "FSI Viewer" to open the image in this unique viewer.</li>
<li>A user may narrow the set of images to be opened with FSI Viewer by utilizing the <strong>Keyword Search</strong> feature at the top left of the <strong>All</strong> or <strong>Images</strong> tabs of My Manager.
<li>Other paths to show (and hence FSI Viewer) include selecting the <strong>Object id</strong> where it is listed in blue type i.e. in another <strong>Show</strong> screen.</li>
<li>The FSI viewer is also available by clicking on an image in a <strong>Collection</strong> from the Browse > Collections tab of the My Manager interface.
</li>
</ul>
<br />
<br />
...
<br />								
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $config->domain;?>About/Manual/services.php" class="button smallButton"><div>Next</DIV></a></td>
