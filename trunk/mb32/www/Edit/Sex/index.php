...
*/
  ...
  /**
   ...
   @subpackage Edit
   @subpackage Sex
   This is the standard script that calls editSex function which displays the form
   for editing Sex reference table.
   ...
   editSex: The function displays the form with all the GUI elements and their javascript
   funtions.
