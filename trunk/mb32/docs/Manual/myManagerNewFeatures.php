...
<div class="specialtext2">All Keyword Searches are <strong>Boolean AND</strong>. Each term entered in Keyword Search is automatically <strong>wild-carded</strong>.
</div>
...
<p><strong>Note Well. </strong>Every Morphbank Object (Image, Specimen, View, Locality, Annotation, Collection, Taxon, Publication) uploaded to Morphbank has a Contributor and Submitter (they can be the same person). Every person with a Morphbank account has their own group to which they can <a href="<?echo $domainName;?>About/Manual/modifyGroup.php">add more members</a>. Any additional Groups needed are currently added by mbadmin. For more about Morphbank Groups, read <a href="<?echo $domainName;?>About/Manual/userPrivileges.php">Users and Their Privileges</a> and how to <a href="<?echo $domainName;?>About/Manual/selectGroup.php">Select a Group</a>.</p>
...
<p>Use the <img src="ManualImages/reset.gif" alt="reset button" /> to clear the Keyword Search and Sort By boxes of all criteria.</p>
	    ...
	    <br />
		<a href="<?echo $domainName;?>About/Manual/myManager.php" ><h3>Known Issues in this Beta Version</h3></a>
		<br />
		<br />
		<a href="<?echo $domainName;?>About/Manual/myManager.php" ><h3>New Features</h3></a>
		<br />
		<br />
			
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerAll.php" class="button smallButton"><div>Next</DIV></a></td>
