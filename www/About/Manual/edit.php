...
<p><a href="<?php echo $config->domain; ?>About/Manual/Movies/EditImage.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Edit images</strong> replacing one image with another: <a href="<?php echo $config->domain; ?>About/Manual/Movies/EditImage.avi" target='_blank'> video</a>
<br /><a href="<?php echo $config->domain; ?>About/Manual/Movies/Changepublishdate.avi" target='_blank'> <img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Edit</strong> date to publish for <strong>lots of images: </strong><a href="<?php echo $config->domain; ?>About/Manual/Movies/Changepublishdate.avi" target='_blank'>video</a> 
<br /><a href="<?php echo $config->domain; ?>About/Manual/Movies/Edit_Specimen_Determination.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Edit Specimen Determination</strong> in Morphbank:<a href="<?php echo $config->domain; ?>About/Manual/Movies/Edit_Specimen_Determination.avi" target='_blank'>video</a></p>
</div>
-->
...
<a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitSpecimen.php">Add Specimen</a></li>.-->
</ul>
...
<li>If a Morphbank Contributor opens a single show using the <img src="../../style/webImages/infoIcon-trans.png" alt="info icon" /> for any of their objects (published or not), the <img src="../../style/webImages/edit-trans.png" /> icon is available inside the single show.</li>
	...
	Collections from the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" /> icon.	</li>
	...
	<a href="<?php echo $config->domain; ?>About/Manual/edit_annotations.php" target="_blank"><h3>Edit Annotations</h3></a> for details.	</li>
	</ul>
</ul>
...
Also you can add or edit <a href="<?php echo $config->domain; ?>About/Manual/externalLink.php#addLink">External Links</a> from this window.  Once you have finished changing the form click the
...
<p>Links can be added to Specimen, Location and Image records. External Links and External Identifiers can be added to any object contributed. Click on the
 blue text <a href="<?php echo $config->domain; ?>About/Manual/externalLink.php#addLink">Add Links</a>
...
<br />
<a href="<?php echo $config->domain; ?>About/Manual/edit_taxon_name.php" target="_blank"><h3>Edit Taxon Names</h3></a>
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/edit_annotations.php" target="_blank"><h3>Edit Annotations</h3></a>
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/edit_collections.php" target="_blank"><h3>Edit Collections</h3></a>
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/edit_annotations.php" class="button smallButton"><div>Next</div></a></td>
