...
<!--<a href="<?echo $domainName;?>Show/index.php?id=224074" target="_blank">http://morphbank.net/Show/index.php?id=224074</a>
-->
<a href="<?echo $domainName;?>Show/?id=224074" target="_blank">http://morphbank.net/Show/?id=224074</a>
...
When browsing / searching via <a href="<?echo $domainName;?>About/Manual/myManager.php" target="_blank">My Manager</a> tabs, the id is displayed with each object. 
<br />
<br />
...
<h3><a name="whereShow">Where can the Show feature be accessed within Morphbank?</a></h3>
	...
	<li>In the <a href="<?echo $domainName;?>About/Manual/myManagerAnnotations.php" target="blank">My Manager > Annotations tab</a>, 
...
complete information on this process refer to the <a href="<?echo $domainName;?>About/Manual/FSI.php">FSI Viewer</a> section of this
...
<br />		
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/zoomingViewer.php" class="button smallButton"><div>Next</DIV></a></td>
