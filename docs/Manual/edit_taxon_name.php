...
<p><a href="<?echo $domainName;?>About/Manual/Movies/Edit_Specimen_Determination.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Edit Specimen Determination</strong> in Morphbank:<a href="<?echo $domainName;?>About/Manual/Movies/Edit_Specimen_Determination.avi" target='_blank'>video</a>
</p>
</div>
<div class="specialtext2">
...
<br />
<br />
A user may <strong>Edit</strong> their contributed <strong>taxon names</strong> by:
<ol>
<li>First, selecting the <strong>Group</strong> the user was logged into when the name was uploaded.
<br />Select the <strong>Group</strong> from the <strong>Header Menu > Tools > Group > groups list</strong> or hover over <strong>Group</strong>
...
<br /> The new search results will be limited to names the logged-in user has uploaded to Morphbank.</li>
