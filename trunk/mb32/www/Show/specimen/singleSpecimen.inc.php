<?php
/**
 *	Script that will display the information for a specimen record/object
 *
 *	This script will be included from the Show/index.php when the $id supplied
 *	points to a specimen object.  The script will then use several different functions
 *	to display the single object show for that specimen.
 *
 *	File: singleSpecimen.inc.php
 *	@package Morphbank2
 *	@subpackage Show
 *
 */
...
function returnLocalityArray () {
	...
	1=>		array('field' => 'locality',
									  ...
									  'width' => 10,
									  'display' => TRUE),
	2=>		array('field' => 'continentOcean',
									  'label' => 'Continent: ',
									  'width' => 10,
									  'display' => false),
	3=>		array('field' => 'country',
									  'label' => 'Country: ',
									  'width' => 10,
									  'display' => false),
	4=>		array('field3' => 'latitude',
									  'field4' => 'Latitude: ',
									  'width' => 10,
									  'latitude' => TRUE,
									  'display' => false),
	5=>		array('field3' => 'longitude',
									  'field4' => 'Longitude: ',
									  'longitude' => TRUE,
									  'width' => 10,
									  'display' => false),
	6=>		array('field' => 'coordinatePrecision',
									  'label' => 'Precision: ',
									  'width' => 10,
									  'display' => false),

	7=>		array('field1' => 'minimumElevation',
									  'field2' => 'maximumElevation',
									  'label' => 'Elevation (m): ',
									  'elevation' => TRUE,
									  'display' => false),
	8=>		array('field1' => 'minimumDepth',
									  'field2' => 'maximumDepth',
									  'label' => 'Depth (m): ',
									  'depth' => TRUE,
									  'display' => false)
