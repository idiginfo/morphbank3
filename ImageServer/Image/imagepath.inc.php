...
function getOriginalImageFilePath($id, $imageType) {
    $imgArray = getAccessImagePath($id, $imageType, $imageType);
    $imgPath = $imgArray['originalSrc'];
    return $imgPath;
}
...
function setTypeExtDir($imgPath, $id, $imgType = 'thumbs', $originalImgType = "") {
    ...
    $originalImageType = ($originalImageType == "tiff") ? "tif" : $originalImageType;
    // all originals in one directory
    $originalImageDir = 'orig';
