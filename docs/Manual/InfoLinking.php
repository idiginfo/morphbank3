...
<div class="mainGenericContainer" width="100%">
    ...
    <td width="100%">
        ...
        <p>Add Uniform Resource Locators (URLs) easily to any Morphbank Object (image, specimen, view, locality, publication, taxon name). When a user
            ...
            <img src="<?php echo $config->domain; ?>style/webImages/edit-trans.png" alt="Edit icon" /> Edit icon for a given object.
        </p>
        ...
        <div class="specialtext2">
            <table cellpadding="2" cellspacing="2" border="1" hspace="30" >
                ...
                <tr><td>Teleost Anatomy Ontology TAO:0001250</td><td>http://bioportal.bioontology.org/virtual/1110/TAO:0001250</td><td><a href="<?php echo $config->domain; ?>?id=478760">http://www.morphbank.net/?id=478760</a></td></tr>
                <tr><td>Handbook of Nearctic Chalcidoidea</td><td>http://codex.begoniasociety.org/chalcidkey/</td><td><a href="<?php echo $config->domain; ?>?id=228786">http://www.morphbank.net/?id=228786</a></td></tr>
                <tr><td>28S</td><td>http://www.ncbi.nlm.nih.gov/entrez/viewer.fcgi?db=nucleotide&amp;val=AY675671</td><td><a href="<?php echo $config->domain; ?>?id=80200">http://www.morphbank.net/?id=80200</a></td></tr>
            </table>
        </div>
        ...
        <img src="<?php echo $config->domain; ?>About/Manual/ManualImages/add_externallinksref_sample.png" hspace="20"/>
        <br />
        <br />
        ...
        <div class="specialtext2">
            <table cellpadding="2" cellspacing="2" border="1" hspace="30">
                ...
                <tr><td>http://morphbank.net</td><td align="center">478760</td><td><a href="<?php echo $config->domain; ?>?id=478760">http://morphbank.net/?id=478760</a></td><td>Morphbank Image Metadata + 400px image</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">228716</td><td><a href="<?php echo $config->domain; ?>?id=228716">http://morphbank.net/?id=228716</a></td><td>Morphbank Specimen Metadata + 400px image</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">575098</td><td><a href="<?php echo $config->domain; ?>?id=575098">http://morphbank.net/?id=575098</a></td><td>Morphbank Collection</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">464413</td><td><a href="<?php echo $config->domain; ?>?id=464413">http://morphbank.net/?id=464413</a></td><td>Morphbank Annotation</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435">http://morphbank.net/?id=579435</a></td><td>Morphbank Image Metadata + 400px image</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=jpeg">http://morphbank.net/?id=579435&amp;imgType=jpeg</a></td><td>Morphbank Image jpeg</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=thumb">http://morphbank.net/?id=579435&amp;imgType=thumb</a></td><td>Morphbank thumbnail</td></tr>
                <tr><td>http://morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=jpeg&amp;imgSize=500">http://morphbank.net/?id=579435&amp;imgType=jpeg&amp;imgSize=500</a></td><td>Morphbank Image with user-specified width</td></tr>
            </table>
        </div>
        ...
        <p>Contributors may link back to (reference) the <strong>metadata</strong> for any object in Morphbank, using the Morphbank unique id for that object.
            -- The Morphbank <a href="<?php echo $config->domain; ?>About/Manual/show.php" target="_blank">Show</a> feature was created to gather and present the associated metadata for
        ...
        <div class="specialtext3">
            See <a href="<?php echo $config->domain; ?>About/Manual/externalLink.php" target="_blank"><b>External Linking - Internal Linking</b>
