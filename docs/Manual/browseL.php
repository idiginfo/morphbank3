...
The Sort feature of morphbank is explained in detail in <a href="<?php echo $config->domain; ?>About/Manual/browseSort.php">Browse - Sort Search Results</a>
<br />
<br />
...
<a href="<?php echo $config->domain; ?>About/Manual/browseImages.php">Browse - Images</a>
...
<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/browseC.php" class="button smallButton"><div>Next</div></a></td>
