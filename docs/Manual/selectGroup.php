...
Membership in a group is also part of the security model Morphbank uses to determine what objects can be seen (or not) by a given individual. To find out more about Morphbank Groups and Group Roles go to the <a href="<?echo $domainName;?>About/Manual/userPrivileges.php">Users and Their Privileges</a> page.
...
Note: Here users may jump to sections in the manual covering <a href="<?echo $domainName;?>About/Manual/uploadSubmit.php">
<strong>Submit</strong></a> and <a href="<?echo $domainName;?>About/Manual/edit.php"><strong> Edit</strong></a>.
</div>
...
<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/modifyGroup.php" class="button smallButton"><div>Next</DIV></a></td>
