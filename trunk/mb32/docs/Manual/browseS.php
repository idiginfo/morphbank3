...
<br />
<br />
As outlined in <a href="<?echo $domainName;?>About/Manual/browseImages.php" target="_blank">Browse - Images</a>,
...
<br />
<br />
As explained in <a href="<?echo $domainName;?>About/Manual/browseSort.php" target="_blank">Browse - Sort Search Results</a>, 
...
documentation on single show refer to <a href="<?echo $domainName;?>About/Manual/show.php">Morphbank Show</a> 
...
<img src="ManualImages/browse_specimen_to_browse_images.png" />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/browseL.php" class="button smallButton"><div>Next</DIV></a></td>
