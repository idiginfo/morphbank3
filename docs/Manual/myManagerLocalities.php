...
<div id=footerRibbon></div>
	...
	<li><a href="<?echo $domainName;?>About/Manual/myManagerFeatures.php" ><strong>Select Mass Operation:</strong></a> 
	...
	for My Manager. 
		...
		<ul>
		<li>The <img src="<?echo $domainName;?>/style/webImages/infoIcon-trans.png" /> icon	shows metadata for the object, 
		in this case the Locality in a format that Morphbank refers to as the <a href="<?echo $domainName;?>About/Manual/show.php" >Show.</a>
		</li>
		<li>Using the <img src="<?echo $domainName;?>/style/webImages/edit-trans.png" /> <strong>Edit</strong> icon gives users access to 
...
together creating a collection, follow the steps in the box next:		
    ...
    <li>Any <strong>Collections</strong> created can be seen in the 
	 <a href="<?echo $domainName;?>About/Manual/myManagerCollections.php" >Collections</a> tab.</li>
	</ul>
...
<a href="<?echo $domainName;?>About/Manual/uploadSubmitLocality.php" ><h3>Add a Locality to Morphbank</h3></a>
<br />
<br />
<a href="<?echo $domainName;?>About/Manual/edit.php" ><h3>Edit a Locality in Morphbank</h3></a>
<br />
<br />
...
<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerTaxa.php" class="button smallButton"><div>Next</DIV></a></td>
