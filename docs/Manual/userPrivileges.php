...
Morphbank user may belong to more than one Morphbank group.

Only Morphbank administrators and group coordinators have access to the group module that manages group
membership.</p>
...
regards to the objects contributed by the group. The Coordinator of the Group decides and can change
