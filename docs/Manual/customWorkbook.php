...
<ul>
<li><a href="<?echo $config->domain;?>docs/scamit.xls">SCAMIT</a>: A data set from an invertebrate taxonomy group in Southern California. Note only fields they use are present. Also, drop-downs
are customized for the taxonomic group of interest as needed for different labs.</li>
<li><a href="<?echo $config->domain;?>docs/usms.xls">USMS</a>: From the herbarium at the University of Southern Mississipi, this data set was generated by mapping an existing database to 
...
<li><a href="<?echo $config->domain;?>docs/talltimbers.xls">Tall Timbers</a>: Similar to the above set, a research station interested in creating an image repostitory of the various specimen
