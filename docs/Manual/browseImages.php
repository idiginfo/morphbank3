...
can be searched, <a href="<?php echo $config->domain; ?>About/Manual/browseSort.php">sorted</a>, <a href="<?php echo $config->domain; ?>About/Manual/browseC.php">collected</a> and 
<a href="<?php echo $config->domain; ?>About/Manual/annotation.php">annotated</a>. If logged-in and using the 
<a href="<?php echo $config->domain; ?>About/Manual/MyManagerImagesTab.php"><strong>My Manager - Images tab</strong></a>, 
...
Browse - View/Specimen/Locality/Collection/Publication.
   ...
   Keywords Table. Please give us <a href="<?php echo $config->domain; ?>/Help/feedback/">feedback</a> on this feature.</div>
<ul>
...
<br />
<br />
The user may now <a href="<?php echo $config->domain; ?>About/Manual/browseSort.php">sort</a> the results or, if logged in, select various images to add to a collection.
<br />
<br />
...
in the <strong><a href="<?php echo $config->domain; ?>About/Manual/myManager.php" >My Manager</a></strong> interface.
</div>
<ul>
...
operation.
<strong>Collections</strong> can be viewed, edited, copied and annotated. See the <a href="<?php echo $config->domain; ?>About/Manual/collections.php"><strong>Collections</strong></a> section of
...
Additional data about the image can be viewed using the <img src="../../style/webImages/infoIcon-trans.png" alt="i icon" />
 icon. Additional data about the taxonomic name can be viewed using the <a href="<?php echo $config->domain; ?>About/Manual/browseTaxonH.php">Taxon Hierarchy </a><img src="../../style/webImages/hierarchryIcon.png" alt="hierarchy button"/> icon<br />
<br />
...
information. For complete documentation on single show refer to <a href="<?php echo $config->domain; ?>About/Manual/show.php">Morphbank Show</a> in the <a href="<?php echo $config->domain; ?>About/Manual/InfoLinking.php">Information Linking</a> section of this manual.
</div>
...
<img src="ManualImages/taxon_hierarchy_sample.png" hspace="20" />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/browseTaxonH.php" class="button smallButton"><div>Next</div></a></td>
