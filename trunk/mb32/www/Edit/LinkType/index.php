...
*/
  ...
  /**
   ...
   @subpackage Edit
   @subpackage LinkType
   This is the standard script that calls editLinkType function which displays the form
   for editing ExternalLinkType reference table.
   ...
   editLinkType: The function displays the form with all the GUI elements and their javascript
   funtions.
...
if ($_REQUEST['pop']) {
  ...
  include_once('editLinkType.php');
  
  // The beginnig of HTML
  $title = 'Edit External Link Type';
