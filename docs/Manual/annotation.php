...
have the same initial title in <a href="<?echo $domainName;?>About/Manual/myManagerAnnotations.php" target="_blank"><strong>My Manager > Annotations tab</strong></a>).</p>
