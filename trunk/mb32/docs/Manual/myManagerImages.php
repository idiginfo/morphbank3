...
<div id=footerRibbon></div>
	...
	<li><a href="<?echo $domainName;?>About/Manual/myManagerFeatures.php" ><strong>Select Mass Operation</strong></a>: After checking one or more Images with the <strong>check
	...
	for My Manager.
		...
		<ul>
		<li>The <img src="<?echo $domainName;?>/style/webImages/infoIcon-trans.png" /> icon	shows data for the image. 
		In general, the <img src="<?echo $domainName;?>/style/webImages/infoIcon-trans.png" /> opens a window that Morphbank 
		calls a <a href="<?echo $domainName;?>About/Manual/show.php" ><strong>Show</strong></a> and it displays 
		the metadata for a given object in Morphbank.		</li>
		<li><img src="<?echo $domainName;?>/style/webImages/edit-trans.png" /> 
		...
		<li>With a click on the <img src="<?echo $domainName;?>/style/webImages/annotate-trans.png" /><a href="<?echo $domainName;?>About/Manual/"><strong>Annotate</strong></a>
		...
		<a href="<?echo $domainName;?>About/Manual/FSI.php">FSI Viewer</a> which allows zooming, rotation and color adjust to help reveal/illuminate
...
<a href="<?echo $domainName;?>About/Manual/uploadSubmitImage.php" ><h3>Add an Image to Morphbank</h3></a>
<br />
<br />
<a href="<?echo $domainName;?>About/Manual/edit.php" ><h3>Edit an Image in Morphbank</h3></a>
<br />
<br />
<a href="<?echo $domainName;?>About/Manual/myManagerCollectionsCreate.php" ><h3>How to Create an Image Collection</h3></a>
<br />
<br />
...
<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerSpecimens.php" class="button smallButton"><div>Next</DIV></a></td>
