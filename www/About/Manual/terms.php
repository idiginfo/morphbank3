...
<div class="mainGenericContainer" width="100%">
    ...
    <td width="100%">
        ...
        <dl>
            ...
            <dt><strong><a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsDefined.php" title="What is a Morphbank Collection?">Collections</a></strong></dt>
            ...
            <dt><strong><a href="<?php echo $config->domain; ?>About/Manual/characterCollections.php" title="What is a Morpbhbank Character Collection?" >Character Collection</a></strong></dt>
            ...
            <dt><strong><a href="<?php echo $config->domain; ?>About/HowToContribute/" title="More information about this process">Delivered uploading</a></strong></dt>
            ...
            <dd> Header Menu button in Morphbank directing the user to: Submit, My Collections, My Manager, Select Group, Account settings, and Log Out.
            </dd>
            <dt><strong>Taxonomic Serial Number (TSN)</strong></dt>
            <dd>The ID number of a specific taxon in the ITIS database.
            </dd>
            <dt><strong>Morphbank Number (mtsn)</strong></dt>
            <dd>A taxonomic identification number assigned by Morphbank to a taxon name added to Morphbank. These
                numbers always begin with 999. The 999 number indicates the name was uploaded to Morphbank. In the future,
                Morphbank plans to retrieve names from existing <em>taxonomic name servers</em> like uBio, Catalog of Life, ZooBank, etc.
                thereby, simplifying upload for Morphbank contributors.
            </dd>
            ...
            <dd> A code indicating a particular kind of specimen. Morphbank currently uses nomenclatural types as defined by ICBN and the ICZN, e.g. holotype, lectotype, paratype, etc.
            </dd>
            ...
            <dd> A type of website that allows users to add, remove, or otherwise edit and change all content very quickly and easily, sometimes without the need for registration (defined from <a href="http://en.wikipedia.org/wiki/Main_Page">http://en.wikipedia.org/wiki/Main_Page</a>) </dd>
        ...
        <div id=footerRibbon></div>
        <table align="right">
            <td><a href="<?php echo $config->domain; ?>About/Manual/screenTips.php" class="button smallButton"><div>Next</div></a></td>
