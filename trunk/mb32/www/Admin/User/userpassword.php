<?php
/**
 * File name: userpassword.php
 * @package Morphbank2
 * @subpackage User
 * 
 * Used to reset user password. Random string generated and set as password
 * then email to the user. User will copy and paste into form during first log in 
 */
