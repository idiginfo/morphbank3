...
in <a href="<?php echo $config->domain; ?>About/Manual/annotationAdd.php">Add Annotations</a> located in this manual. After the
...
<img src="ManualImages/edit_annotation_screen.jpg" vspace="10" hspace="20"/>
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/edit_collections.php" class="button smallButton"><div>Next</div></a></td>
