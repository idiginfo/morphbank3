...
*/
  ...
  include_once('filters/mirrorFilter.class.php');
  include_once('filters/sort.class.php');
  
  $sortByFields = array(0 => array('field' => 'serverId', 'label' => 'Server Id', 'width' => 40, 'toSort' => true, 'inGet' => 0, 'order' => 'DESC'), 1 => array('field' => 'groupName', 'label' => 'Title', 'width' => 40, 'toSort' => true, 'inGet' => 0, 'order' => 'ASC'), 2 => array('field' => 'url', 'label' => 'Server Address', 'width' => 60, 'toSort' => true, 'inGet' => 0, 'order' => 'ASC'), 3 => array('field' => 'locality', 'label' => 'Location', 'width' => 50, 'toSort' => true, 'inGet' => 0, 'order' => 'ASC'), 4 => array('field' => 'dateCreated', 'label' => 'Date Created', 'width' => 30, 'toSort' => false, 'inGet' => 0, 'order' => 'ASC'));
  ...
  class resultControls
  {
      ...
      function setupFilters()
      {
          ...
          $mirrorFilter = new mirrorFilter($config->domain);
          $mirrorFilter->setIsTheFirst(true);
          $mirrorFilter->setForItSeft(true);
          
          global $sortByFields;
          $sortFilter = new sort($config->domain, $sortByFields);
          
          $this->filterList[0] = $mirrorFilter;
      ...
      {
          $sql = 'SELECT ServerInfo.*, Groups.groupName ' . 'FROM ServerInfo INNER JOIN Groups ON ServerInfo.mirrorGroup = Groups.id ';
          
          /* Needs to have setIsTheFirst to FALSE to have the where here
