...
<li>Mapping to Morphbank. One-Time Fee @ RATE:  $30.00 /  hour</br>
...
Upload of one workbook of this size will take 1 -2 hours and assumes the contributor does the following:
	...
	<li>Adds any Taxon Names that need adding (via the web-interface) or the Specimen Taxon Data sheet in the Workbook.
	</li>
