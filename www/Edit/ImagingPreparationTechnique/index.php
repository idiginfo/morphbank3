...
*/
  ...
  /**
   ...
   This is the standard script that calls editImgPrep function which displays the form
   for editing ImgaingPreparationTechnique  reference table.
   ...
   editImgTech: The function displays the form with all the GUI elements and their javascript
   funtions.
...
if ($_REQUEST['pop']) {
  ...
  include_once('editImgPrep.php');
  
  // The beginnig of HTML
  $title = 'Edit Preparation Technique';
  ...
  if ($_GET['code'] == '0')
      echo '<h3><b>Imaging Preparation Technique exists with id ' . $_GET['id'] . '.</b></h3><br /><br />';
  
  if ($_GET['code'] == '1')
      echo '<h3><b>You have successfully Updated Imaging Preparation Technique </b></h3><br /><br />';
  elseif ($_GET['code'] == '3') {
      echo '<b>You do not have permissions to update Imaging Preparation Technique</b><br /><br />
