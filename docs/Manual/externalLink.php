...
Morphbank copyright information <a href="<?php echo $config->domain; ?>About/Copyright/" target="_blank">http://www.morphbank.net/About/Copyright/</a>).</li>
</ul>
<hr align="left" width="650" height="5" color="#AAB0D0" />
<h2>External Links - Adding to any Morphbank record</h2>
<p> Morphbank Contributors using <a href="<?php echo $config->domain; ?>About/Manual/submit.php"><em>mass upload</em></a> methods may add these external links during upload. Information needed includes the:</p>
<ul>
...
Note: A Morphbank Contributor or Submitter can add external links from anywhere the <img src="../../style/webImages/edit-trans.png" /> icon appears in any <a href="<?php echo $config->domain; ?>About/Manual/myManager.php" target="_blank">My Manager</a> tab. It's done
...
<br />
<a href="<?php echo $config->domain; ?>134312"><img src="ManualImages/external_link_sample.png" vspace="20" hspace="30"  /></a>
<br />
<hr align="left" width="650" height="5" color="#AAB0D0" />
...
<a href="<?php echo $config->domain; ?>Show/?id=64122" target="_blank">http://www.morphbank.net/Show/?id=64122</a>.
</li>
</ul>
...
<tr><td>http://www.morphbank.net</td><td align="center">478760</td><td><a href="<?php echo $config->domain; ?>?id=478760">http://www.morphbank.net/?id=478760</a></td><td>Morphbank Image Metadata + 400px image</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">228716</td><td><a href="<?php echo $config->domain; ?>?id=228716">http://www.morphbank.net/?id=228716</a></td><td>Morphbank Specimen Metadata + 400px image</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">575098</td><td><a href="<?php echo $config->domain; ?>?id=575098">http://www.morphbank.net/?id=575098</a></td><td>Morphbank Collection</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">464413</td><td><a href="<?php echo $config->domain; ?>?id=464413">http://www.morphbank.net/?id=464413</a></td><td>Morphbank Annotation</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435">http://www.morphbank.net/?id=579435</a></td><td>Morphbank Image Metadata + 400px image</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=jpeg">http://www.morphbank.net/?id=579435&amp;imgType=jpeg</a></td><td>Morphbank Image jpeg</td></tr>
<tr><td>http://www.morphbank.net</td><td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=thumb">http://www.morphbank.net/?id=579435&amp;imgType=thumb</a></td><td>Morphbank thumbnail</td></tr>
<tr><td height="32">http://www.morphbank.net</td>
<td align="center">579435</td><td><a href="<?php echo $config->domain; ?>?id=579435&amp;imgType=jpeg&amp;imgSize=500">http://www.morphbank.net/?id=579435&amp;imgType=jpeg&amp;imgSize=500</a></td><td>Morphbank Image with user-specified width</td></tr>
</table>
</div>
...
The URL looks like: <a href="<?php echo $config->domain; ?>?id=65847" target="_blank">http://www.morphbank.net/?id=65847</a><br />
...
<br />
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/show.php" class="button smallButton"><div>Next</div></a></td>
