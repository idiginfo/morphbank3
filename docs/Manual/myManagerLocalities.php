...
<div id=footerRibbon></div>
	...
	<li><a href="<?php echo $config->domain; ?>About/Manual/myManagerFeatures.php" ><strong>Select Mass Operation:</strong></a> 
	...
	for My Manager. 
		...
		<ul>
		<li>The <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" /> icon	shows metadata for the object, 
		in this case the Locality in a format that Morphbank refers to as the <a href="<?php echo $config->domain; ?>About/Manual/show.php" >Show.</a>
		</li>
		<li>Using the <img src="<?php echo $config->domain; ?>style/webImages/edit-trans.png" /> <strong>Edit</strong> icon gives users access to 
		change/update data for any <strong>Localities</strong> they've contributed/submitted.
		</li>
		<li>Note the <img src="<?php echo $config->domain; ?>style/webImages/camera-min.gif" width="16" height="16"> is a link to all 
...
together creating a collection, follow the steps in the box next:		
    ...
    <li>Any <strong>Collections</strong> created can be seen in the 
	 <a href="<?php echo $config->domain; ?>About/Manual/myManagerCollections.php" >Collections</a> tab.</li>
	</ul>
...
<a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitLocality.php" ><h3>Add a Locality to Morphbank</h3></a>
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/edit.php" ><h3>Edit a Locality in Morphbank</h3></a>
<br />
<br />
...
<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/myManagerTaxa.php" class="button smallButton"><div>Next</div></a></td>
