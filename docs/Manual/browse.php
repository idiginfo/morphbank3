...
<ul>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseImages.php">Images</a></strong> (View a sortable list of all images in
...
<li><strong><a href="<?echo $domainName;?>About/Manual/browseTaxonH.php">Taxon hierarchy</a></strong> (View all kingdoms from
the top level of the taxonomic hierarchy or users can traverse the taxon
hierarchy using only major categories).
</li>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseTaxonN.php">Alphabetical taxon name</a></strong> (All taxon names
...
<li><strong><a href="<?echo $domainName;?>About/Manual/browseV.php">View</a></strong> (Search for views based
on a keyword or a sortable list of all the registered views within the
database).
</li>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseS.php">Specimen</a></strong> (Search for
specimens based on a keyword or a sortable list of all the specimens
currently located on the Morphbank database).
</li>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseL.php">Locality</a></strong> (Search for localities
based on a keyword or a sortable list of all the available localities within
the database).
</li>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseC.php">Collections</a></strong> (Search for
existing collections based on a keyword or a sortable list of all the
available collections within the database).
</li>
<li><strong><a href="<?echo $domainName;?>About/Manual/browseP.php">Publication</a></strong> (Search for
existing publications based on a keyword or a sortable list of all the
available publications within the database).
</li>
<!--<li><strong><a href="<?echo $domainName;?>About/Manual/browseM.php" target="_blank">Mirrors</a></strong> (Search current morphbank mirrors).
</li>-->
</ul>
</p>
			<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/browseImages.php" class="button smallButton"><div>Next</DIV></a></td>
