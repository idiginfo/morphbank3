...
-->
<li>Published records may not be edited.</li>
<li>If you find a problem with a published record 
please contact <b>mbadmin <font color="blue">at</font> scs <font color="blue">dot</font> fsu <font color="blue">dot</font> edu</b> for help.</li>
...
<li>Click the <img src="../../style/webImages/edit-trans.png" /> icon to open the <strong>Edit popup</strong> for a particular object.</li>
...
<p>This Edit manual page contains general instructions for how to edit most Morphbank Objects including:
<ul>
<li>Image</li>
<li>Specimen</li>
<li>View</li>
...
<li>If a Morphbank Contributor opens a single show using the <img src="../../style/webImages/infoIcon-trans.png" alt="info icon" /> for any of their objects (published or not), the <img src="../../style/webImages/edit-trans.png" /> icon is available inside the single show.</li>
	...
	Collections from the <img src="<?echo $domainName;?>/style/webImages/infoIcon-trans.png" /> icon.
	</li>
	...
	<a href="<?echo $domainName;?>About/Manual/edit_annotations.php" target="_blank"><h3>Edit Annotations</h3></a> for details.
	</li>
	</ul>
...
<br /><img src="../../style/webImages/envelope.gif" /> Mail: This icon indicates that you cannot directly change or add but can email <b>mbadmin <font color="blue">at</font> scs <font color="blue">dot</font> fsu <font color="blue">dot</font> edu</b> and request a change.
<br /><img src="../../style/webImages/selectIcon.png" /> Browse: To modify the record you must select from already existing records
<br /><img src="../../style/webImages/plusIcon.png" /> Add a record: You can add a new record by clicking on the plus
</p>
...
My Manager, a user selects the tab (Images, Views, Localities, Specimens, Publications, Collections, Annotations) of choice and then searches (and/or Limits) to find the object/s to be edited. Then, use the <img src="../../style/webImages/edit-trans.png" /> icon to open the Edit pop-up.
</div>
<p>
At the moment, you may edit your Locality, Specimen, View, Image, Publication, Annotation, &amp; Collection records in two different ways,
<ol>
<li>via the <img src="../../style/webImages/edit-trans.png" /> icon found at Header Menu > Browse > My Manager > choose tab
</li>
<li>or via the <img src="../../style/webImages/edit-trans.png" /> icon in any single show.
</li>
</ol> 
</p>
For example: if you know a specific location record is incorrect, go to Browse > Locality, search for that record and click the edit icon. This icon will take you to the <strong>Edit Locality</strong> page where you can modify information about that specific location record.
<br />
<img src="ManualImages/edit_locality.jpg" vspace="5" />
<br />
...
<br />
<br />-->
<b>To access a specific record it is best to use Edit 
via the <img src="../../style/webImages/edit-trans.png" /> icon in My Manager.</b>
<br /> 
</p>
<p>
...
click on the <img src="../../style/webImages/selectIcon.png" /> and choose it from the list of images.
</p>
<br />
<br />
<img src="ManualImages/choose_standard_image.jpg" />
<br /> 
</p>
<br />
<br /><b>Delete:</b>
<br />You can delete or replace an image, or delete a record in the system if no one has used the image or annotated the information.  Please 
contact <b>mbadmin <font color="blue">at</font> scs <font color="blue">dot</font> fsu <font color="blue">dot</font> edu</b>
 if you have any questions about deleting. You will see the 
 <img src="../../style/webImages/delete-trans.png" height="16" width="16" alt="delete icon" /> if you have delete privileges for a given object.
</p>
<p>
<b>Adding and Editing Links:</b>
<p>Links can be added to Specimen, Location and Image records. Click on the
...
<img src="ManualImages/edit_add_links.png" />
...
<li>add a completely new Specimen record or View associated with the 
selected image.</li>
<li>and if the image is <em>unpublished</em>, a user may replace the image.</li>
<li>Users cannot currently edit the existing Specimen record, View, or Locality data from this page. Go directly to My Manager or Browse, 
find the Specimen or View to be edited, click the <img src="../../style/webImages/edit-trans.png" /> icon next to the Specimen or View</strong>
to change details of the data for those objects.</li>
</ul>
</p>
