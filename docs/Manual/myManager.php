...
<div class="specialtext3">Go to <a href="<?echo $domainName;?>About/Manual/screenTips.php">Screen Use Tips</a> for a general introduction to all the icons and special features found on Morphbank pages.
</div>
...
<h2>Unique Features of My Manager and Morphbank</h2>
			...
			<div class="specialtext2">
			<ul>
			<li>Change the date to publish for many of your objects at one time using the <a href="<?echo $domainName;?>/About/Manual/myManagerFeatures.php" >
            <strong>"Select Mass Operation"</strong></a></li>
			<li><a href="<?echo $domainName;?>/About/Manual/myManagerFeatures.php" ><strong>Easily limit your search</strong></a> by your group, all of the groups to which you
			...
			<li><strong>Create <a href="<?echo $domainName;?>About/Manual/characterCollections.php" target="_blank">Character Collections</a></strong>. 
...
<h2>Known Version Issues</h2>
		<div class="specialtext2">
		 My Manager is presently under the last stages of development.  Most of these issues are resolved and
		  ...
		  <a href="<?echo $domainName;?>/Help/feedback/" target="_blank">feedback</a> if you have suggestions!
		 <ul>
         ...
         provide <a href="<?echo $domainName;?>/About/Manual/terms.php" ><strong>unique external identifiers (GUID)s</strong></a> via the same interface.</li>
		 </ul>
		 </div>
		...
		<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerFeatures.php" class="button smallButton"><div>Next</DIV></a></td>
