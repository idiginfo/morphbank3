...
<a href="<?php echo $config->domain; ?>About/Manual/Movies/SubmitSpecimen.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Submit a Specimen</strong>: <a href="<?php echo $config->domain; ?>About/Manual/Movies/SubmitSpecimen.avi" target='_blank'> video</a>
</div>
-->
...
see the <a href="<?php echo $config->domain; ?>About/Manual/addTaxonName.php">ITIS, Add Taxon Name</a> section of this manual.
</li>
<br />
...
form.
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitView.php" class="button smallButton"><div>Next</div></a></td>
