...
<h3>Features and Functions of the Collections tab</h3>
	<p> Note the highlighted areas of the above image briefly explained next. Image / Mixed Collections &amp; Character Collections are found in this tab. OTU collections are found in the <a href="<?php echo $config->domain; ?>About/Manual/myManagerTaxa.php"><strong>Taxa</strong></a> tab.</p>
	
	<ul>
	
	<li><a href="<?php echo $config->domain; ?>About/Manual/manualHints.php" ><img src="ManualImages/feedback.png" align="middle"></a>: please use this link to our automated feedback system. We appreciate your comments so that 
	we can continue to improve and enhance Morphbank. Clicking on <strong><font color="red">(Help)</font></strong> opens this Manual.</li>
	
	<li><a href="<?php echo $config->domain; ?>About/Manual/myManagerFeatures.php" target="_blank"><strong>Keywords: </strong></a> Use the new <strong>enhanced</strong> search feature. Hold the mouse over the
	...
	<li><a href="<?php echo $config->domain; ?>About/Manual/myManagerFeatures.php" target="_blank"><strong>Limit Search by:</strong></a> 	allows a user to view only the objects personally contributed/submitted AND/OR those from a particular group. Use the 
	...
	<li><a href="<?php echo $config->domain; ?>About/Manual/myManagerFeatures.php" target="_blank"><strong>Select Mass Operation</strong></a>:
	...
	for My Manager.
		...
		<ul>
		<li>Briefly, the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" /> icon
	...
	<li><a href="<?php echo $config->domain; ?>About/Manual/zoomingViewer.php" target="_blank"><strong>Zooming Viewer</strong></a>: Morphbank utilizes
...
<a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsCreate.php" target="_blank"><h3>Create a Collection</h3></a>
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsSample.php" target="_blank"><h3>A Sample Collection</h3></a>
<br />
<br />
...
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsDefined.php" target="_blank"><h3>What exactly is a Collection?</h3></a>
<br />
<br />
<a href="<?php echo $config->domain; ?>About/Manual/characterCollections.php" target="_blank"><h3>Character Collections</h3></a>
		<br />
		<br />
...
<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsDefined.php" class="button smallButton"><div>Next</div></a></td>
