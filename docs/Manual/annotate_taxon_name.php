...
<a href="<?echo $domainName;?>About/Manual/Movies/AddTaxonNamenew.avi" target='_blank'><img src="ManualImages/movieicon.jpg" /></a>  How to <strong>Annotate </strong>a taxon name: <a href="<?echo $domainName;?>About/Manual/Movies/AddTaxonNamenew.avi" target='_blank'>video</a>
</div>
...
<a href="<?echo $domainName;?>About/Manual/annotationAdd.php#pathToAnnotation">Paths to Annotation</a>
</div>
...
<br />When a published Manuscript Name is given a Regular Scientific Name you cannot change the original manuscript
 ...
 Morphbank with Type of Name being 'regular scientific name,' then add an annotation to the manuscript name.
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerPublications.php" class="button smallButton"><div>Next</DIV></a></td>
