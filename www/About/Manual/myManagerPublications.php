...
<h2>Features and Functions of the Publications tab in My Manager</h2>
	...
	overview.</li>
		...
		<li>In Morphbank, the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" />
	 	...
	 	<a href="<?php echo $config->domain; ?>About/Manual/edit_publications.php">Edit Publication</a> section.</li>
		</ul>
		</ul>
...
<br /> In this case, the <img src="<?php echo $config->domain; ?>style/webImages/infoIcon-trans.png" />
...
Publications to Morphbank. Directions for this process are located in <a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitPublication.php">
