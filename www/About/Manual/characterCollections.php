...
In this version of the software continuous and ordered characters are not supported.  Please use the <a href="<?php echo $config->domain; ?>Help/feedback/" target="_blank">feedback form</a> and send us email
...
<br />The Character Collection interface is a workspace for defining characters.  The general functionality of the collection is the same as a
 <a href="<?php echo $config->domain; ?>About/Manual/myManagerCollectionsSample.php">regular collection</a> in Morphbank where you can slide sort images, 
...
<br /><br />
<img src="<?php echo $config->domain; ?>About/Manual/ManualImages/character_collection.png">
<br /><br />
...
<br />Every image in Morphbank is given a taxon name at the time of upload.  These names can be valid and accepted names from ITIS or they can be
 manuscript names added by the user.  Check out the <a href="<?php echo $config->domain; ?>About/Manual/addTaxonName.php">Add Taxon Name</a> section of the manual for more information on how to add a taxon name.  Applying a character state to a Morphbank Image is a way to make an annotation on that taxon, specimen or OTU (Operational Taxonomic Unit) associated with the Image.
...
2. Add all of your character states by clicking the Add State button for each new state you wish to add, then drag the images tiles (representing OTUs) behind a tile.  This process is done one image at a time.
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/myManagerAnnotations.php" class="button smallButton"><div>Next</div></a></td>
