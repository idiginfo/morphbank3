...
<ul>
	<li>Valid Morphbank username and password (obtained through the <a href="<?php echo $config->domain; ?>About/Manual/login.php">login
    ...
    <li>Have ready any URL information so that any object contributed to Morphbank can be linked to a page/s outside Morphbank. <a href="<?php echo $config->domain; ?>				About/Manual/externalLink.php" >External Links</a> can be added to any Morphbank object (Locality, Specimen, View, Image, Publication).
	</li>
</ul>			
...
<ul>
	<li><a href="<?php echo $config->domain; ?>About/Manual/uploadSubmitPublication.php" >Publications</a> that reference Morphbank objects.</li>
	<li><a href="<?php echo $config->domain; ?>About/Manual/addTaxonName.php" >Taxon Names</a> needed before submitting specimens and their associated images.
  		<ul>
    		<li>Two methods to check for presence or absence of taxon names in Morphbank:</li>
      			<ol>
        			<li><a href="<?php echo $config->domain; ?>/Help/nameMatch/">Name Query</a>: use this to check long lists of names.</li>
        			<li> or login to use <a href="<?php echo $config->domain; ?>Admin/TaxonSearch/">Taxon Search</a> for short lists.</li>
        		</ol>
	...
	<li>A <a href="<?php echo $config->domain; ?>About/Manual/updateAccount.php" >Contributor Logo</a> and any associated URL for that Logo to be displayed with every object submitted by 		    this Morpbbank user.</li>
</ul>
...
<li><strong>Morphbank Excel Workbook:</strong> Users wishing to contribute 100 - 250 images at a time, may find this method useful. A multi-page Excel Workbook is populated by the Contributor. Morphbank staff uploads the completed workbook. If users need assistance to complete the workbook, Morphbank staff steps in to assist. This workbook and an accompanying manual are found at:
	<ul>
    <li><a href="<?php echo $config->domain; ?>docs/mb3p.xls">Morphbank Excel Workbook</a> - tailored with views for <strong>Plantae</strong> &amp; 
    <a href="<?php echo $config->domain; ?>docs/mb3wbmanual.pdf">Manual</a>    </li>
    <li><a href="<?php echo $config->domain; ?>docs/mb3a.xls">Morphbank Excel Workbook</a> - tailored with views for <strong>Animalia</strong> &amp; <a href="<?php echo $config->domain; ?>docs/mb3wbmanual.pdf">Manual</a>	</li>
    </ul>
 </li>
<br />
...
<li><strong>Morphbank via <a href="http://specifysoftware.org/">Specify6</a>:</strong> In progress, software is being designed and written to enable those with data in <a href="http://specifysoftware.org/">Specify6</a> to upload directly to Morphbank with the click of a button. While this method inserts data into Morphbank, software is also being written to automate the Image upload process.  </li>
	    ...
	    <br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?php echo $config->domain; ?>About/Manual/uploadSubmit.php" class="button smallButton"><div>Next</div></a></td>
