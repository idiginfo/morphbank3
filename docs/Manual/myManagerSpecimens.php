...
<p>Path to the Specimens tab <em>after login </em>is <strong>Header Menu > Browse > Specimen</strong>. Or, click <strong>Browse</strong> in the Header, then click on the <strong>Specimen tab</strong>.</p>
	...
	<li><a href="<?echo $domainName;?>About/Manual/myManagerFeatures.php" ><strong>Select Mass Operation</strong></a>: After checking one or more Specimens with the <strong>check
	...
	for My Manager.
	<p>Briefly, the <img src="<?echo $domainName;?>/style/webImages/infoIcon-trans.png" /> icon
	shows metadata for the image.
	<br />
	The <img src="<?echo $domainName;?>/style/webImages/edit-trans.png" /> icon
	...
	<li>Any <strong>OTU</strong> collections created can be seen in the <a href="<?echo $domainName;?>About/Manual/myManagerTaxa.php" >Taxa tab</a>
	</li>
	</ul>
	<br />
    ...
    <li><a href="<?echo $domainName;?>About/Manual/FSI.php" ><strong>FSI Viewer</strong></a>: Morphbank utilizes a 
...
<a href="<?echo $domainName;?>About/Manual/uploadSubmitSpecimen.php" ><h3>Add a Specimen to Morphbank</h3></a>
<br /><br />
<a href="<?echo $domainName;?>About/Manual/edit.php" ><h3>Edit a Specimen in Morphbank</h3></a>
<br /><br />					
		...
		<br />
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/myManagerViews.php" class="button smallButton"><div>Next</DIV></a></td>
