...
<div id=footerRibbon></div>
			...
			<tr>-->
<p>
After log-in, the user is now automatically taken to the<a href="<?echo $config->domain;?>About/Manual/myManagerImages.php" target="_blank">
 Images</a> tab of the new (beta)
<a href="<?echo $config->domain;?>About/Manual/myManager.php" target="_blank">
...
not available to all Morphbank members. Each <a href="<?echo $config->domain;?>About/Manual/myManager.php" target="_blank">
...
Note: The instructions for <a href="<?echo $config->domain;?>About/Manual/uploadSubmit.php">
<strong>Submit</strong></a>, and <a href="<?echo $config->domain;?>About/Manual/edit.php"><strong> Edit</strong></a> are covered here in Morphbank 
modules. For directions in the use of <a href="<?echo $config->domain;?>About/Manual/browse.php"> <strong>Browse</strong></a> or <a href="<?echo $config->domain;?>About/Manual/search.php"><strong>Search</strong></a> return to appropriate section in this manual.
</div>
