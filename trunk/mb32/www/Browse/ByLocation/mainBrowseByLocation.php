<?php
/**
 * File name: mainBrowseByLocation.php
 * Lists Specimens. Clicking on the view icon gives
 * detailed description of Location.
 *
 * @author Neelima Jammigumpula <jammigum@csit.fsu.edu> and Wilfredo Blanco <blanco@scs.fsu.edu>
 * @package Morphbank2
 * @subpackage Browse
 *
 */
