...
<?php
  /**
   ...
   This script has only one function editPart that displays the GUI and form data from the database.
   **/
  
  function editPart()
  {
      //These are declared global so that they can be used anywhere in the function. 
      ...
      $totalNumRows = mysqli_num_rows(runQuery('SELECT name AS SpecimenPart, description AS Description FROM SpecimenPart ORDER BY name;'));
      $result = runQuery('SELECT name AS SpecimenPart, description AS Description FROM SpecimenPart ORDER BY name LIMIT ' . $offset . ', 20;');
      
      $numRows = mysqli_num_rows($result);
      
      echo '<form  name = "editPart" method = "post" action = "modifyPart.php" onsubmit = "return checkall()" >
    <h1><b>Edit Specimen Part</b></h1>
    <br /><br />';
      ...
      <table width="600"> <tr><td><b>Specimen Part <span class="req">*</span></b></td>
...
?>
  ...
  <table width="600">
    <tr>
      <td align = "right"><a href = "javascript: checkall()" class="button smallButton"><div>Update</div> </a>
