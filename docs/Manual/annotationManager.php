...
<p>
The <strong>My Manager > Annotation tab</strong> offers the user a list of all the annotations that have
...
Search or Limit By features to show display a select group of annotations.
</p>
<img src="ManualImages/tools_select_group.jpg" hspace="20" />
<p>The <strong>Annotation tab (manager of the user's personal annotations)</strong>, is
directly accessed by choosing <strong>My Manager</strong> from the <strong>Tools </strong>menu
(located on the opening Morphbank screen or on the page header) and then choose the Annotation Tab.</p>

<!--<img src="ManualImages/annotation_manager_sample.jpg" />-->
...
<strong>.XML </strong> and <strong>Taxon Name</strong> (see <a href="<?echo $domainName;?>About/Manual/annotationTypes.php">Types of Annotations</a> later in this chapter.)</li>
...
changes, click on the update button.</li>
			...
			<div id=footerRibbon></div>
			<table align="right">
<td><a href="<?echo $domainName;?>About/Manual/annotationTypes.php" class="button smallButton"><div>Next</DIV></a></td>
